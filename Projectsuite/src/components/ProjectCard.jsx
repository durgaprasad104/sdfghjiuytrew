...
const ProjectCard = ({ project, index }) => {
    ...
    return (
        ...
        >
            {/* Glow Effect */}
            <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-purple-600 opacity-0 group-hover:opacity-20 transition duration-500 blur-lg"></div>
                    ...
                    <div className="mt-auto">
                        ...
                        <div className="flex items-center justify-between pt-5 border-t border-gray-100">
                            <div className="flex space-x-2">
                                ...
                                <a href={project.codeLink} className="p-2 text-gray-400 hover:text-gray-900 hover:bg-gray-100 rounded-full transition-all hover:scale-110" title="View Code">
